...
This project adheres to strict ethical and legal standards, ensuring transparency and compliance in all aspects of data handling and development:

- **Data Privacy:** All data used in this project was sourced from publicly available Google Cloud Sustainability Reports (2019-2023). No private or sensitive information was accessed or utilized during the development of this dashboard.
- **Transparency:** The datasets and visualizations included in this repository are provided with full attribution to their original sources.
- **Fair Use Compliance:** The analysis and insights generated by this project align with fair use principles and are intended solely for educational and research purposes.
- **GDPR Alignment:** While no personal data was processed, the project follows GDPR principles by ensuring that all analyses respect data privacy and ethical standards.
